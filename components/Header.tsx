  ...
  return (
    <header>
      ...
      src="https://links.papareact.com/c2cdd5"
       ...
       />
       <div className="flex items-center space-x-5  flex-1 justify-end width-full ">
...
<Avatar name="Patrick Mak" round size="50" color="#0055D1" />
       </div>
       </div>
       <div className="flex items-center justify-center py-2 px-5 md:py-5">
        <p className="flex items-center text-sm  p-5 font-light pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl text-[#0055D1]">
          ...
          GPT is summarisng your tasks for the day...
        </p>
        </div>
      </header>
  )
